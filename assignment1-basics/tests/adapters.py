...
import cs336_basics.utils_train
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.utils import scaled_dot_product
...
def run_transformer_block(
    ...
    """
    from cs336_basics.utils import TransformerBlock
...
def run_transformer_lm(
    ...
    transformer = Transformer(vocab_size, d_model, num_heads, d_ff, rope_theta, context_length, num_layers)
...
def run_get_batch(
    ...
    """
    from cs336_basics.utils_train import get_batch
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.utils_train import cross_entropy
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    cs336_basics.utils_train.clip_gradients(parameters, max_l2_norm)
...
def get_adamw_cls() -> type[torch.optim.Optimizer]:
    ...
    """
    from cs336_basics.utils_train import AdamW
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.utils_train import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.utils_train import load_checkpoint
